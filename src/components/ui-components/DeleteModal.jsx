...
export default function DeleteModal({ onClose, title, message, onClick, cancelButton="Cancel", deleteButton="Delete"}) {
    ...
    return (
        <div className="fixed inset-0 z-30 flex items-end bg-gray-600 bg-opacity-50 sm:items-center sm:justify-center">
            ...
            >
                ...
                <footer className="flex flex-col items-center gap-4 justify-end px-6 py-3 -mx-6 -mb-4 space-y-4 sm:space-y-0 sm:space-x-6 sm:flex-row bg-gray-50 dark:bg-gray-800">
                    <button
                        ...
                        onClick={onClose}
                    >
                        {authLang[langs[lang]][cancelButton]}
                    </button>
                    <button
                        ...
                        onClick={onClick}
                    >
                        {authLang[langs[lang]][deleteButton]}
                    </button>
                </footer>
            </div>
        </div>
